module fields
   ...
   use geometry, only: lm_max, n_r_max, lm_maxMag, n_r_maxMag, &
       ...
       &                 n_lm_loc, n_lmMag_loc, nRstart, nRstop 
...
contains
   ...
   subroutine initialize_fields
      ...
      allocate( flow_Rdist_container(n_lm_loc,nRstart:nRstop,1:7) )
      w_Rdist(1:n_lm_loc,nRstart:nRstop)   => flow_Rdist_container(:,:,1)
      dw_Rdist(1:n_lm_loc,nRstart:nRstop)  => flow_Rdist_container(:,:,2)
      ddw_Rdist(1:n_lm_loc,nRstart:nRstop) => flow_Rdist_container(:,:,3)
      z_Rdist(1:n_lm_loc,nRstart:nRstop)   => flow_Rdist_container(:,:,4)
      dz_Rdist(1:n_lm_loc,nRstart:nRstop)  => flow_Rdist_container(:,:,5)
      p_Rdist(1:n_lm_loc,nRstart:nRstop)   => flow_Rdist_container(:,:,6)
      dp_Rdist(1:n_lm_loc,nRstart:nRstop)  => flow_Rdist_container(:,:,7)
      ...
      s_Rdist(1:n_lm_loc,nRstart:nRstop)   => s_Rdist_container(:,:,1)
      ds_Rdist(1:n_lm_loc,nRstart:nRstop)  => s_Rdist_container(:,:,2)

      allocate( s_Rdist_test(n_lm_loc,nRstart:nRstop,1:2) )  !DELETEME
      
      bytes_allocated = bytes_allocated + &
                        9*(ulm-llm+1)*n_r_max*SIZEOF_DEF_COMPLEX
      bytes_allocated = bytes_allocated + &
                        9*n_lm_loc*(nRstop-nRstart+1)*SIZEOF_DEF_COMPLEX
      ...
      if ( l_chemical_conv ) then
         ...
         xi_Rdist(1:n_lm_loc,nRstart:nRstop)   => xi_Rdist_container(:,:,1)
         dxi_Rdist(1:n_lm_loc,nRstart:nRstop)  => xi_Rdist_container(:,:,2)
         bytes_allocated = bytes_allocated + &
      ...
      b_Rdist(1:n_lmMag_loc,nRstart:nRstop)   => field_Rdist_container(:,:,1)
      db_Rdist(1:n_lmMag_loc,nRstart:nRstop)  => field_Rdist_container(:,:,2)
      ddb_Rdist(1:n_lmMag_loc,nRstart:nRstop) => field_Rdist_container(:,:,3)
      aj_Rdist(1:n_lmMag_loc,nRstart:nRstop)  => field_Rdist_container(:,:,4)
      dj_Rdist(1:n_lmMag_loc,nRstart:nRstop)  => field_Rdist_container(:,:,5)
      bytes_allocated = bytes_allocated + &
                        5*n_lmMag_loc*(nRstop-nRstart+1)*SIZEOF_DEF_COMPLEX
